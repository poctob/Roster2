...
@SessionScoped
public class ClockEventController implements Serializable {

    private ClockEvent current;
    private DataModel items = null;
    @EJB
    private net.xpresstek.roster2.web.ClockEventFacade ejbFacade;
    ...
    private ClockEventFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (ClockEvent) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ClockEventCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ClockEventUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ClockEventDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public ClockEvent getClockEvent(java.lang.Integer id) {
