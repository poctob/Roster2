...
@SessionScoped
public class ClockOutReasonsController implements Serializable {
    ...
    public ClockOutReasons getSelected() {
        if (current == null) {
    ...
    private ClockOutReasonsFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (ClockOutReasons) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ClockOutReasonsCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ClockOutReasonsUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ClockOutReasonsDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public ClockOutReasons getClockOutReasons(java.lang.Integer id) {
